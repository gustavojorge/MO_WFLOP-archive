...
# O diretório temp já foi criado anteriormente, não precisamos de mkdir para ele
...
# Normalização: RobustScaler (médias robustas contra outliers)
scaler = RobustScaler()
